...
def draw_floor():
    ...
    screen.blit(floor,(floor_x_pos+423,650))
def create_pipe():
...
def score_display(game_state):
    ...
    if game_state =='game_over':  
        ...
        high_score_rect=score_surface.get_rect(center=(170,630))
...
while True:
    ...
    if game_active:
        ...
        rotadted_bird= rotate_bird(bird) 
        bird_rect.centery+= bird_movement
        screen.blit(rotadted_bird,bird_rect) 
    ...
    floor_x_pos-=1       
    draw_floor()
    if floor_x_pos <= -432: #chạy floor vô tận
       floor_x_pos=0             
